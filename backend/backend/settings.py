...
SECRET_KEY = 'django-insecure-^$%&1&=#z222a6rl)&dpu$k)44nkr8+jn#+=3i31^a+g3p63lu'
...
"""mongoengine.connect(
    ...
    host='mongodb://localhost:27017/',           # Hostname (or connection string)
...
#     "http://localhost:3000",  # Example for React app running on this port
#     "http://127.0.0.1:8000",
# ]
